    ...
    <div className="relative w-full max-w-md mx-auto h-96 flex items-center justify-center">
      <AnimatePresence>
        {cards.map((video, index) => (
          <motion.div
            key={video.id}
            className="absolute w-80 h-64 bg-white rounded-2xl shadow-2xl overflow-hidden cursor-grab active:cursor-grabbing"
            style={{
          ...
          >
            ...
            <div className="h-full flex flex-col">
              ...
              {/* Card Info */}
              <div className={`p-4 bg-gradient-to-r ${video.color}`}>
